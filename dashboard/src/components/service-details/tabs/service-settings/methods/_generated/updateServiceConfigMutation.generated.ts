...
export const UpdateServiceConfigDocument = gql`
    mutation UpdateServiceConfig($serviceId: String!, $config: DeploymentConfigUpdateInput!) {
  updateServiceConfig(serviceId: $serviceId, config: $config)
}
    `;
export type UpdateServiceConfigMutationFn = Apollo.MutationFunction<UpdateServiceConfigMutation, UpdateServiceConfigMutationVariables>;
 ...
 * });
 */
export function useUpdateServiceConfigMutation(baseOptions?: Apollo.MutationHookOptions<UpdateServiceConfigMutation, UpdateServiceConfigMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateServiceConfigMutation, UpdateServiceConfigMutationVariables>(UpdateServiceConfigDocument, options);
      }
export type UpdateServiceConfigMutationHookResult = ReturnType<typeof useUpdateServiceConfigMutation>;
export type UpdateServiceConfigMutationResult = Apollo.MutationResult<UpdateServiceConfigMutation>;
export type UpdateServiceConfigMutationOptions = Apollo.BaseMutationOptions<UpdateServiceConfigMutation, UpdateServiceConfigMutationVariables>;