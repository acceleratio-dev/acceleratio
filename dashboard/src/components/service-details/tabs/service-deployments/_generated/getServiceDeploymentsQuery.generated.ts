...
export type GetServiceDeploymentsQuery = { __typename?: 'Query', deployments: Array<{ __typename?: 'Deployment', _id: string, status: DeploymentStatus, containerId: string | null, containerStatus: ContainerStatus | null, createdAt: any, updatedAt: any, config: { __typename?: 'DeploymentConfig', image: string } }> };
