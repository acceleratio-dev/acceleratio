import { Cloudy, Folders, History, UsersRound } from "lucide-react"
                            ...
                            <TooltipProvider key={link.label} delayDuration={100}>
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <Link 
                                            href={link.href} 
                                            className="block p-2.5 rounded-md transition-all duration-200 hover:bg-slate-300/60 group relative" 
                                        >
