'use client'
import { ArrowRightFromLine, Cloudy, Folders, History, UsersRound } from "lucide-react"
                        ...
                        links.map((link) => (
                            <TooltipProvider key={link.label} delayDuration={200}>
                                <Tooltip>
                                    ...
                                    <TooltipContent className="px-1.5 py-1" side="right" sideOffset={8}>
