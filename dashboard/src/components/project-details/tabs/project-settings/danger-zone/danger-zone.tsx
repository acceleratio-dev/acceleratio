...
import { useDeleteProjectMutation } from './_generated/deleteProjectMutation.generated';
import { toast } from 'sonner';
import { useRouter } from 'next/navigation';

export const DangerZone = ({ projectId }: { projectId: string }) => {
  const router = useRouter();
  const [triggerMutation, { loading }] = useDeleteProjectMutation({
    onError: (error) => {
