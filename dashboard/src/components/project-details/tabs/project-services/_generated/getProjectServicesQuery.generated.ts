...
export type GetProjectServicesQuery = { __typename?: 'Query', services: Array<{ __typename?: 'ServiceWithDeployment', _id: string, name: string, type: ServiceType, projectId: string, createdAt: any, updatedAt: any, activeDeployment: { __typename?: 'Deployment', status: DeploymentStatus, containerStatus: ContainerStatus | null, createdAt: any, updatedAt: any } | null, draftDeployment: { __typename?: 'Deployment', status: DeploymentStatus, containerStatus: ContainerStatus | null, createdAt: any, updatedAt: any } | null }> };
