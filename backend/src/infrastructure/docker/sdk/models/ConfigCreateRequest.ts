...
/**
 * Check if a given object implements the ConfigCreateRequest interface.
 */
export function instanceOfConfigCreateRequest(value: object): value is ConfigCreateRequest {
    return true;
}

export function ConfigCreateRequestFromJSON(json: any): ConfigCreateRequest {
    return ConfigCreateRequestFromJSONTyped(json, false);
}

export function ConfigCreateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfigCreateRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ConfigCreateRequestToJSONTyped(value?: ConfigCreateRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
