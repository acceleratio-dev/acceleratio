...
import type { ServiceSpecModeReplicated } from './ServiceSpecModeReplicated';
import {
...
/**
 * Check if a given object implements the ServiceSpecMode interface.
 */
export function instanceOfServiceSpecMode(value: object): value is ServiceSpecMode {
    return true;
}

export function ServiceSpecModeFromJSON(json: any): ServiceSpecMode {
    return ServiceSpecModeFromJSONTyped(json, false);
}

export function ServiceSpecModeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceSpecMode {
    if (json == null) {
        return json;
    }
    return {
        
        'replicated': json['Replicated'] == null ? undefined : ServiceSpecModeReplicatedFromJSON(json['Replicated']),
        'global': json['Global'] == null ? undefined : json['Global'],
        'replicatedJob': json['ReplicatedJob'] == null ? undefined : ServiceSpecModeReplicatedJobFromJSON(json['ReplicatedJob']),
...
export function ServiceSpecModeToJSONTyped(value?: ServiceSpecMode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'Global': value['global'],
        'ReplicatedJob': ServiceSpecModeReplicatedJobToJSON(value['replicatedJob']),
