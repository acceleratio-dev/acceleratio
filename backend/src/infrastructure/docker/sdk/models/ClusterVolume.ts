...
export function ClusterVolumeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClusterVolume {
    ...
    return {
        ...
        'publishStatus': json['PublishStatus'] == null ? undefined : ((json['PublishStatus'] as Array<any>).map(ClusterVolumePublishStatusInnerFromJSON)),
    };
}
...
export function ClusterVolumeToJSONTyped(value?: ClusterVolume | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'PublishStatus': value['publishStatus'] == null ? undefined : ((value['publishStatus'] as Array<any>).map(ClusterVolumePublishStatusInnerToJSON)),
    };
}
