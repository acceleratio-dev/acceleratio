...
/**
 * Check if a given object implements the ServiceCreateRequest interface.
 */
export function instanceOfServiceCreateRequest(value: object): value is ServiceCreateRequest {
    return true;
}

export function ServiceCreateRequestFromJSON(json: any): ServiceCreateRequest {
    return ServiceCreateRequestFromJSONTyped(json, false);
}

export function ServiceCreateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceCreateRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ServiceCreateRequestToJSON(json: any): ServiceCreateRequest {
    return ServiceCreateRequestToJSONTyped(json, false);
}

export function ServiceCreateRequestToJSONTyped(value?: ServiceCreateRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
