...
/**
 * Check if a given object implements the MountTmpfsOptions interface.
 */
export function instanceOfMountTmpfsOptions(value: object): value is MountTmpfsOptions {
    return true;
}

export function MountTmpfsOptionsFromJSON(json: any): MountTmpfsOptions {
    return MountTmpfsOptionsFromJSONTyped(json, false);
}

export function MountTmpfsOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): MountTmpfsOptions {
    if (json == null) {
        return json;
    }
    return {
...
export function MountTmpfsOptionsToJSONTyped(value?: MountTmpfsOptions | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
