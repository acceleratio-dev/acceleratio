 ...
 */
export function instanceOfClusterVolumePublishStatusInner(value: object): value is ClusterVolumePublishStatusInner {
    return true;
}

export function ClusterVolumePublishStatusInnerFromJSON(json: any): ClusterVolumePublishStatusInner {
    return ClusterVolumePublishStatusInnerFromJSONTyped(json, false);
}

export function ClusterVolumePublishStatusInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClusterVolumePublishStatusInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ClusterVolumePublishStatusInnerToJSONTyped(value?: ClusterVolumePublishStatusInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
