 ...
 */
export function instanceOfTaskSpecContainerSpecSecretsInner(value: object): value is TaskSpecContainerSpecSecretsInner {
    return true;
}

export function TaskSpecContainerSpecSecretsInnerFromJSON(json: any): TaskSpecContainerSpecSecretsInner {
    return TaskSpecContainerSpecSecretsInnerFromJSONTyped(json, false);
}

export function TaskSpecContainerSpecSecretsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaskSpecContainerSpecSecretsInner {
    if (json == null) {
        return json;
    }
    return {
        
        'file': json['File'] == null ? undefined : TaskSpecContainerSpecSecretsInnerFileFromJSON(json['File']),
        'secretID': json['SecretID'] == null ? undefined : json['SecretID'],
        'secretName': json['SecretName'] == null ? undefined : json['SecretName'],
    };
}

export function TaskSpecContainerSpecSecretsInnerToJSON(json: any): TaskSpecContainerSpecSecretsInner {
    return TaskSpecContainerSpecSecretsInnerToJSONTyped(json, false);
}

export function TaskSpecContainerSpecSecretsInnerToJSONTyped(value?: TaskSpecContainerSpecSecretsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
