...
export function ServiceUpdateStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceUpdateStatus {
    if (json == null) {
        return json;
    }
    return {
...
export function ServiceUpdateStatusToJSONTyped(value?: ServiceUpdateStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
