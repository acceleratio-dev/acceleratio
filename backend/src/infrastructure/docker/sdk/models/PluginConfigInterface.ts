...
export function PluginConfigInterfaceFromJSONTyped(json: any, ignoreDiscriminator: boolean): PluginConfigInterface {
    if (json == null) {
        return json;
    }
    return {
...
export function PluginConfigInterfaceToJSONTyped(value?: PluginConfigInterface | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
