...
export function TLSInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): TLSInfo {
    ...
    return {
        ...
        'certIssuerPublicKey': json['CertIssuerPublicKey'] == null ? undefined : json['CertIssuerPublicKey'],
    };
}
...
export function TLSInfoToJSONTyped(value?: TLSInfo | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
