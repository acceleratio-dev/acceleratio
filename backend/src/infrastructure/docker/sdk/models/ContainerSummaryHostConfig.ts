...
/**
 * Check if a given object implements the ContainerSummaryHostConfig interface.
 */
export function instanceOfContainerSummaryHostConfig(value: object): value is ContainerSummaryHostConfig {
    return true;
}

export function ContainerSummaryHostConfigFromJSON(json: any): ContainerSummaryHostConfig {
    return ContainerSummaryHostConfigFromJSONTyped(json, false);
}

export function ContainerSummaryHostConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContainerSummaryHostConfig {
    if (json == null) {
        return json;
    }
    return {
...
export function ContainerSummaryHostConfigToJSONTyped(value?: ContainerSummaryHostConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
