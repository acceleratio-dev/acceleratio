...
export function ServiceSpecUpdateConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceSpecUpdateConfig {
    if (json == null) {
        return json;
    }
    return {
...
export function ServiceSpecUpdateConfigToJSONTyped(value?: ServiceSpecUpdateConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
