...
/**
 * Check if a given object implements the PushImageInfo interface.
 */
export function instanceOfPushImageInfo(value: object): value is PushImageInfo {
    return true;
}

export function PushImageInfoFromJSON(json: any): PushImageInfo {
    return PushImageInfoFromJSONTyped(json, false);
}

export function PushImageInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): PushImageInfo {
    if (json == null) {
        return json;
    }
    return {
...
export function PushImageInfoToJSONTyped(value?: PushImageInfo | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
