...
export function PluginConfigLinuxFromJSONTyped(json: any, ignoreDiscriminator: boolean): PluginConfigLinux {
    if (json == null) {
        return json;
    }
    return {
...
export function PluginConfigLinuxToJSONTyped(value?: PluginConfigLinux | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
