 ...
 */
export function instanceOfEndpointSpec(value: object): value is EndpointSpec {
    return true;
}

export function EndpointSpecFromJSON(json: any): EndpointSpec {
    return EndpointSpecFromJSONTyped(json, false);
}

export function EndpointSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): EndpointSpec {
    if (json == null) {
        return json;
    }
    return {
...
export function EndpointSpecToJSONTyped(value?: EndpointSpec | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
