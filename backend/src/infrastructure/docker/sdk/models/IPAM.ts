...
/**
 * Check if a given object implements the IPAM interface.
 */
export function instanceOfIPAM(value: object): value is IPAM {
    return true;
}

export function IPAMFromJSON(json: any): IPAM {
    return IPAMFromJSONTyped(json, false);
}

export function IPAMFromJSONTyped(json: any, ignoreDiscriminator: boolean): IPAM {
    if (json == null) {
        return json;
    }
    return {
        ...
        'config': json['Config'] == null ? undefined : ((json['Config'] as Array<any>).map(IPAMConfigFromJSON)),
...
export function IPAMToJSONTyped(value?: IPAM | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'Driver': value['driver'],
        'Config': value['config'] == null ? undefined : ((value['config'] as Array<any>).map(IPAMConfigToJSON)),
