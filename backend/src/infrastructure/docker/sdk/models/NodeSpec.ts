 ...
 */
export function instanceOfNodeSpec(value: object): value is NodeSpec {
    return true;
}
...
export function NodeSpecToJSONTyped(value?: NodeSpec | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
