...
/**
 * Check if a given object implements the ServiceUpdateRequest interface.
 */
export function instanceOfServiceUpdateRequest(value: object): value is ServiceUpdateRequest {
    return true;
}

export function ServiceUpdateRequestFromJSON(json: any): ServiceUpdateRequest {
    return ServiceUpdateRequestFromJSONTyped(json, false);
}

export function ServiceUpdateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceUpdateRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ServiceUpdateRequestToJSONTyped(value?: ServiceUpdateRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
