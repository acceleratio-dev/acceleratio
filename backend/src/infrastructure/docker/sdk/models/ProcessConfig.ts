...
/**
 * Check if a given object implements the ProcessConfig interface.
 */
export function instanceOfProcessConfig(value: object): value is ProcessConfig {
    return true;
}

export function ProcessConfigFromJSON(json: any): ProcessConfig {
    return ProcessConfigFromJSONTyped(json, false);
}

export function ProcessConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProcessConfig {
    if (json == null) {
        return json;
    }
    return {
...
export function ProcessConfigToJSONTyped(value?: ProcessConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
