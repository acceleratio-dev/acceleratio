...
import type { GenericResourcesInnerNamedResourceSpec } from './GenericResourcesInnerNamedResourceSpec';
import {
...
/**
 * Check if a given object implements the GenericResourcesInner interface.
 */
export function instanceOfGenericResourcesInner(value: object): value is GenericResourcesInner {
    return true;
}

export function GenericResourcesInnerFromJSON(json: any): GenericResourcesInner {
    return GenericResourcesInnerFromJSONTyped(json, false);
}

export function GenericResourcesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericResourcesInner {
    if (json == null) {
        return json;
    }
    return {
        
        'namedResourceSpec': json['NamedResourceSpec'] == null ? undefined : GenericResourcesInnerNamedResourceSpecFromJSON(json['NamedResourceSpec']),
        'discreteResourceSpec': json['DiscreteResourceSpec'] == null ? undefined : GenericResourcesInnerDiscreteResourceSpecFromJSON(json['DiscreteResourceSpec']),
    };
}
...
export function GenericResourcesInnerToJSONTyped(value?: GenericResourcesInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'DiscreteResourceSpec': GenericResourcesInnerDiscreteResourceSpecToJSON(value['discreteResourceSpec']),
    };
}
