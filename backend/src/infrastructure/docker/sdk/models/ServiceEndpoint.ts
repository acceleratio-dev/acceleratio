...
import type { ServiceEndpointVirtualIPsInner } from './ServiceEndpointVirtualIPsInner';
import {
...
export function ServiceEndpointFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceEndpoint {
    ...
    return {
        ...
        'spec': json['Spec'] == null ? undefined : EndpointSpecFromJSON(json['Spec']),
        'ports': json['Ports'] == null ? undefined : ((json['Ports'] as Array<any>).map(EndpointPortConfigFromJSON)),
        'virtualIPs': json['VirtualIPs'] == null ? undefined : ((json['VirtualIPs'] as Array<any>).map(ServiceEndpointVirtualIPsInnerFromJSON)),
    };
}
...
export function ServiceEndpointToJSONTyped(value?: ServiceEndpoint | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'VirtualIPs': value['virtualIPs'] == null ? undefined : ((value['virtualIPs'] as Array<any>).map(ServiceEndpointVirtualIPsInnerToJSON)),
    };
}
