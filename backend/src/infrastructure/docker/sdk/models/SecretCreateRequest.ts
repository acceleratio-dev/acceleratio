...
/**
 * Check if a given object implements the SecretCreateRequest interface.
 */
export function instanceOfSecretCreateRequest(value: object): value is SecretCreateRequest {
    return true;
}

export function SecretCreateRequestFromJSON(json: any): SecretCreateRequest {
    return SecretCreateRequestFromJSONTyped(json, false);
}

export function SecretCreateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SecretCreateRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'driver': json['Driver'] == null ? undefined : DriverFromJSON(json['Driver']),
        'templating': json['Templating'] == null ? undefined : DriverFromJSON(json['Templating']),
    };
}
...
export function SecretCreateRequestToJSONTyped(value?: SecretCreateRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'Templating': DriverToJSON(value['templating']),
    };
}
