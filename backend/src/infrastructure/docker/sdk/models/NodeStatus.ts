...
export function NodeStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): NodeStatus {
    ...
    return {
        ...
        'state': json['State'] == null ? undefined : NodeStateFromJSON(json['State']),
...
export function NodeStatusToJSONTyped(value?: NodeStatus | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
