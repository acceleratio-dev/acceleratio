...
export function LocalNodeStateFromJSON(json: any): LocalNodeState {
    return LocalNodeStateFromJSONTyped(json, false);
}

export function LocalNodeStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocalNodeState {
    return json as LocalNodeState;
}
...
export function LocalNodeStateToJSONTyped(value: any, ignoreDiscriminator: boolean): LocalNodeState {
