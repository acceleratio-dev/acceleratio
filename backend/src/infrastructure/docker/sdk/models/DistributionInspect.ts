...
/**
 * Check if a given object implements the DistributionInspect interface.
 */
export function instanceOfDistributionInspect(value: object): value is DistributionInspect {
...
export function DistributionInspectFromJSON(json: any): DistributionInspect {
    return DistributionInspectFromJSONTyped(json, false);
}

export function DistributionInspectFromJSONTyped(json: any, ignoreDiscriminator: boolean): DistributionInspect {
    if (json == null) {
        return json;
    }
    return {
        ...
        'platforms': ((json['Platforms'] as Array<any>).map(OCIPlatformFromJSON)),
    };
}
...
export function DistributionInspectToJSONTyped(value?: DistributionInspect | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
