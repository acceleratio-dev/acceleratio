...
export function EndpointPortConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): EndpointPortConfig {
    if (json == null) {
        return json;
    }
    return {
...
export function EndpointPortConfigToJSONTyped(value?: EndpointPortConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
