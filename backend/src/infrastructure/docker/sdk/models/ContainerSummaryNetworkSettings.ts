...
/**
 * Check if a given object implements the ContainerSummaryNetworkSettings interface.
 */
export function instanceOfContainerSummaryNetworkSettings(value: object): value is ContainerSummaryNetworkSettings {
    return true;
}

export function ContainerSummaryNetworkSettingsFromJSON(json: any): ContainerSummaryNetworkSettings {
    return ContainerSummaryNetworkSettingsFromJSONTyped(json, false);
}

export function ContainerSummaryNetworkSettingsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContainerSummaryNetworkSettings {
    if (json == null) {
        return json;
    }
    return {
...
export function ContainerSummaryNetworkSettingsToJSONTyped(value?: ContainerSummaryNetworkSettings | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
