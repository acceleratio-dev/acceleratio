 ...
 */
export function instanceOfServiceSpecRollbackConfig(value: object): value is ServiceSpecRollbackConfig {
    return true;
}
...
export function ServiceSpecRollbackConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceSpecRollbackConfig {
    if (json == null) {
        return json;
    }
    return {
...
export function ServiceSpecRollbackConfigToJSONTyped(value?: ServiceSpecRollbackConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
