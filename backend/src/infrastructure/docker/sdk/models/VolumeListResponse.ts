...
/**
 * Check if a given object implements the VolumeListResponse interface.
 */
export function instanceOfVolumeListResponse(value: object): value is VolumeListResponse {
    return true;
}

export function VolumeListResponseFromJSON(json: any): VolumeListResponse {
    return VolumeListResponseFromJSONTyped(json, false);
}

export function VolumeListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): VolumeListResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function VolumeListResponseToJSONTyped(value?: VolumeListResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
