...
export function MountBindOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): MountBindOptions {
    if (json == null) {
        return json;
    }
    return {
...
export function MountBindOptionsToJSONTyped(value?: MountBindOptions | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
