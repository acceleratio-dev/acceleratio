...
import type { ClusterVolumeSpecAccessMode } from './ClusterVolumeSpecAccessMode';
import {
...
export function ClusterVolumeSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClusterVolumeSpec {
    ...
    return {
        ...
        'accessMode': json['AccessMode'] == null ? undefined : ClusterVolumeSpecAccessModeFromJSON(json['AccessMode']),
    };
}
...
export function ClusterVolumeSpecToJSONTyped(value?: ClusterVolumeSpec | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
