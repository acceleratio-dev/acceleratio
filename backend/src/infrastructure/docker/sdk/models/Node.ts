...
export function NodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): Node {
    ...
    return {
        ...
        'description': json['Description'] == null ? undefined : NodeDescriptionFromJSON(json['Description']),
        'status': json['Status'] == null ? undefined : NodeStatusFromJSON(json['Status']),
        'managerStatus': json['ManagerStatus'] == null ? undefined : ManagerStatusFromJSON(json['ManagerStatus']),
    };
}
