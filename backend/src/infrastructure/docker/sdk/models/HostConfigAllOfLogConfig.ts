 ...
 */
export function instanceOfHostConfigAllOfLogConfig(value: object): value is HostConfigAllOfLogConfig {
    return true;
}

export function HostConfigAllOfLogConfigFromJSON(json: any): HostConfigAllOfLogConfig {
    return HostConfigAllOfLogConfigFromJSONTyped(json, false);
}

export function HostConfigAllOfLogConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): HostConfigAllOfLogConfig {
    if (json == null) {
        return json;
    }
    return {
...
export function HostConfigAllOfLogConfigToJSONTyped(value?: HostConfigAllOfLogConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
