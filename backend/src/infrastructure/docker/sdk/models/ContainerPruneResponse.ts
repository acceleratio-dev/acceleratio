...
export function ContainerPruneResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContainerPruneResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ContainerPruneResponseToJSONTyped(value?: ContainerPruneResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
