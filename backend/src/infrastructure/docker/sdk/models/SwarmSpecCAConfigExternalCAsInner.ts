 ...
 */
export function instanceOfSwarmSpecCAConfigExternalCAsInner(value: object): value is SwarmSpecCAConfigExternalCAsInner {
    return true;
}

export function SwarmSpecCAConfigExternalCAsInnerFromJSON(json: any): SwarmSpecCAConfigExternalCAsInner {
    return SwarmSpecCAConfigExternalCAsInnerFromJSONTyped(json, false);
}

export function SwarmSpecCAConfigExternalCAsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): SwarmSpecCAConfigExternalCAsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function SwarmSpecCAConfigExternalCAsInnerToJSON(json: any): SwarmSpecCAConfigExternalCAsInner {
    return SwarmSpecCAConfigExternalCAsInnerToJSONTyped(json, false);
}

export function SwarmSpecCAConfigExternalCAsInnerToJSONTyped(value?: SwarmSpecCAConfigExternalCAsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
