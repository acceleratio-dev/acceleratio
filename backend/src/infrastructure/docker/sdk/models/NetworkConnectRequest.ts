...
/**
 * Check if a given object implements the NetworkConnectRequest interface.
 */
export function instanceOfNetworkConnectRequest(value: object): value is NetworkConnectRequest {
    return true;
}

export function NetworkConnectRequestFromJSON(json: any): NetworkConnectRequest {
    return NetworkConnectRequestFromJSONTyped(json, false);
}

export function NetworkConnectRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): NetworkConnectRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'endpointConfig': json['EndpointConfig'] == null ? undefined : EndpointSettingsFromJSON(json['EndpointConfig']),
    };
}
...
export function NetworkConnectRequestToJSONTyped(value?: NetworkConnectRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
