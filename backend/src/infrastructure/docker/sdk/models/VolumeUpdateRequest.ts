...
/**
 * Check if a given object implements the VolumeUpdateRequest interface.
 */
export function instanceOfVolumeUpdateRequest(value: object): value is VolumeUpdateRequest {
    return true;
}

export function VolumeUpdateRequestFromJSON(json: any): VolumeUpdateRequest {
    return VolumeUpdateRequestFromJSONTyped(json, false);
}

export function VolumeUpdateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): VolumeUpdateRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function VolumeUpdateRequestToJSONTyped(value?: VolumeUpdateRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
