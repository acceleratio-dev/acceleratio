...
import type { MountImageOptions } from './MountImageOptions';
import {
    MountImageOptionsFromJSON,
    MountImageOptionsFromJSONTyped,
    MountImageOptionsToJSON,
    MountImageOptionsToJSONTyped,
} from './MountImageOptions';
...
export function MountFromJSONTyped(json: any, ignoreDiscriminator: boolean): Mount {
    ...
    return {
        ...
        'imageOptions': json['ImageOptions'] == null ? undefined : MountImageOptionsFromJSON(json['ImageOptions']),
...
export function MountToJSONTyped(value?: Mount | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'ImageOptions': MountImageOptionsToJSON(value['imageOptions']),
