...
export function NodeStateFromJSON(json: any): NodeState {
    return NodeStateFromJSONTyped(json, false);
}

export function NodeStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): NodeState {
